...
import org.chobit.tiger.model.TreeNode;
import org.chobit.tiger.model.Pair;
import org.chobit.tiger.service.entity.AbstractEntity;
import org.chobit.tiger.service.entity.Category;
import org.chobit.tiger.service.mapper.CategoryMapper;
import org.chobit.tiger.utils.Args;
...
import static org.chobit.tiger.utils.Collections2.isEmpty;
import static org.chobit.tiger.utils.Collections2.pairToMap;
...
public class CategoryService {
    ...
    public List<org.chobit.tiger.model.Category> findCatByParent(int parent) {
        ...
        List<org.chobit.tiger.model.Category> list = new LinkedList<>();
        for (Category m : cats) {
            list.add(new org.chobit.tiger.model.Category(m, map.getOrDefault(m.getId(), 0L).intValue()));
        }
        return list;
    }
