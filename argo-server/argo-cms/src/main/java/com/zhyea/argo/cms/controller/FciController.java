...
public class FciController {
     ...
     */
    @RequestMapping("/add")
    public Long add(@RequestBody @Valid FciAddRequest request) {
     ...
     */
    @PostMapping("/edit")
    public boolean edit(@RequestBody @Valid FciEditRequest request) {
     ...
     */
    @PostMapping("/get")
    public FciItem get(@RequestBody @Valid FciIdRelateRequest request) {
     ...
     */
    @PostMapping("/delete")
    public boolean delete(@RequestBody @Valid FciIdRelateRequest request) {
     ...
     */
    @PostMapping("/list")
    public PageResult<FciItem> findInPage(@RequestBody @Valid FciQueryRequest request) {
    ...
    public List<FciItem> findByPageCode(@RequestBody @Valid FciPageCodeRequest request) {
